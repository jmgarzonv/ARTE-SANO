...
from .views import (
    ...
    ver_carrito, agregar_al_carrito,productos_mas_vendidos,finalizar_compra, eliminar_del_carrito, iniciar_sesion, cerrar_sesion ,registro, detalle_compra, cambiar_idioma
)
...
urlpatterns = [
    ...
    path('cambiar-idioma/<str:idioma>/', cambiar_idioma, name='cambiar_idioma'),
