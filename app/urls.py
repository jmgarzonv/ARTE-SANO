...
from .views import (
    lista_pedidos, lista_productos, crear_producto, eliminar_producto,
    comprar_producto, ver_wishlist, agregar_a_wishlist, eliminar_de_wishlist,
    ver_carrito, agregar_al_carrito, productos_mas_vendidos, finalizar_compra,
    eliminar_del_carrito, iniciar_sesion, cerrar_sesion, registro,
    detalle_compra
)
...
urlpatterns = [
    ...
    path('pedido/<int:pedido_id>/detalle/', detalle_compra, name='detalle_compra'),
]
