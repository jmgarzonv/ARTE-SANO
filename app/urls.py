...
from .views import (
    ...
    ver_carrito, agregar_al_carrito,productos_mas_vendidos,finalizar_compra, eliminar_del_carrito, iniciar_sesion, cerrar_sesion ,registro, cambiar_idioma # Asegurar estas importaciones
)
